...
public class Main {
	...
	public static void main(String[] args) {
		...
		int userInput = 5; //while girmesi için
		
		while (userInput != 0) {
			
			System.out.println("1 - Giriþ Yap");
			System.out.println("2 - Kayýt Ol");
			...
			if (userInput == 1) {
				System.out.println("Giriþ Ekraný");
				...
				System.out.println("Kayýt Ekraný");
				...
				User user = new User(1, name, lastName, email, password); //hepsinde id 1 olacak bunu çözemedim
